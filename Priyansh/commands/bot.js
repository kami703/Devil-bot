...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "Kami") || (event.body.toLowerCase() == "Devil") || (event.body.toLowerCase() == "devil") || (event.body.toLowerCase() == "prince")) {
     return api.sendMessage( "Busy HoGa Bachiyo Me Main t0o Hun Naw Baby 😘",threadID);


   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞⟬ 𝐆A͜͡𝐍𝐆𝐒𝐓E͜͡𝐑 ⟭⸙⟬ دیـﹻ۬ﹻۧ۬ﹻٰ۬ﹻٰ۬ﹻۧ۬ﹻ۬ﹻـول ⟭☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ⟬ دیـﹻ۬ﹻۧ۬ﹻٰ۬ﹻٰ۬ﹻۧ۬ﹻ۬ﹻـول ⟭🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ https://www.facebook.com/profile.php?id=61570398352958👋For Any Kind Of Help Contact On wha 😇", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is Devil / kami. He Gives his name Devil everywhare", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bts") || (event.body.toLowerCase() == "btc")) {
     return api.sendMessage("Tu H Btc Matlab Khusra. Bhos DK", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Noor") || (event.body.toLowerCase() == "noor")) {
     return api.sendMessage("️> [ Noor Noor Kiya Kr Raha Hai Noor Bs Mere Owner Kami Ki Hai Samjha? ] <", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Ahmi") || (event.body.toLowerCase() == "ahmi")) {
     return api.sendMessage("️> Ahmi Tutiya Mere Owner Devil Ka best friend Hai Samjha Na? <", threadID);
   };

   if ((event.body.toLowerCase() == "Abbas") || (event.body.toLowerCase() == "abbas")) {
     return api.sendMessage("️> Abbas bs Mehar Ka Hai Or Mere Owner Devil Ka Bhai Hai Samjha? <", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
   ...
   if ((event.body.toLowerCase() == "muj ko v piyar karo koi") || (event.body.toLowerCase() == "nobody love me") || (event.body.toLowerCase() == "koi pyar nhi karta")) {
     return api.sendMessage("️Me huna baby mere pass aao 🥰🤗. Me karunga na aapko payar 🙈 (londo tum dur hi rahna saalo 😑)", threadID);
   };

   if ((event.body.toLowerCase() == "Mehar") || (event.body.toLowerCase() == "mehar")) {
     return api.sendMessage("️> Mehar Mehar Kiya Kr Raha Hai Mehar Bs Abbas Ki Hai Samjha na? <", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i lob you")) {
   ...
   if ((event.body.toLowerCase() == "&fuck") || (event.body.toLowerCase() == "&Fuck")) {
     return api.sendMessage("🏔️🏝️Devil Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣɵ Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
   };

  if ((event.body.toLowerCase() == "Assalam") || (event.body.toLowerCase() == "Assalamu alikom") || (event.body.toLowerCase() == "Assalm u alikom") || (event.body.toLowerCase() == "Assalmoalikom") || (event.body.toLowerCase() == "As")) {
